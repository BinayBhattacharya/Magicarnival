...
const Faq = () => {
    return (
        ...
        <div className="ans">If you are looking for originality, customization, flawless quality animation-wise, and you want to work with a team of professionals that love what they do, then your search is over!<br /><br />
          With over more than 300 videos under our belt - with clients like Walmart, McKesson, DocuSign, and many other big and small names - customer satisfaction remains our primary concern. But hey! You don't have to take our word for it, see for yourself what our clients have to say about our work!<br /><br />
        ...
        <div className="ans">Many factors play a part in our service' pricing: style, run-time/length, and deadlines (how quickly you need it done) will all end up influencing the price of your video.<br /><br />
          That said, an animated video usually averages anywhere between $7,000 and $15,000.<br /><br />
          If you'd like an accurate quote, we are happy to give you one without much hassle! Just click here and get in touch.</div><br /><br /><br /><br /><br /> 
        ...
        <div className="ans">Our usual production cycle requires six weeks, plus however long it takes to integrate clients' feedback and changes into the piece. When it's all said and done, most projects take between seven to nine weeks from beginning to final product delivery.</div><br /><br /><br /><br /><br />
        ...
        <div className="ans">We have a simple process that gives you ample opportunities to provide feedback and request changes.</div><br /><br /><br /><br /><br />
        ...
        <div className="ans">Our in-house team is made up of creative professionals with many different skills. We craft and produce all our video pieces and work with creatives all around the globe to create videos specially tailored to your needs.</div><br /><br /><br /><br /><br />
        <div className="quest" id="q10">10. What is the payment process?</div>
        <div className="ans">We'll send you a short contract so both parties agree to the video production and then we'll request an upfront payment of 50% to get started and the other half is required once the video is completed and approved. We accept wire transfers and PayPal at the moment.</div><br /><br /><br /><br /><br />
        ...
        <div className="ans">We recommend keeping them under 2 minutes long - 90 seconds being the sweet spot for explainer videos. Want more details on why? Check out this cool piece we wrote on the subject.
        </div><br /><br /><br /><br /><br />
        ...
        <div className="ans">Every single video we make here at Yum Yum videos is entirely built from the ground up and tailored to our clients' needs!<br /><br />
